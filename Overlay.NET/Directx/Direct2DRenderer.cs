...
namespace Overlay.NET.Directx
{
    ...
    public class Direct2DRenderer
    {
        ...
        public WindowRenderTarget GetDevice() => _device;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void DrawLine(float startX, float startY, float endX, float endY, float stroke, int brush) => _device.DrawLine(new RawVector2(startX, startY), new RawVector2(endX, endY), _brushContainer[brush], stroke);
        ...
        /// <param name="brush">The brush.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void DrawRectangle(float x, float y, float width, float height, float stroke, int brush) => _device.DrawRectangle(new RawRectangleF(x, y, x + width, y + height), _brushContainer[brush], stroke);
        ...
        /// <param name="brush">The brush.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void DrawCircle(float x, float y, int radius, float stroke, int brush) => _device.DrawEllipse(new Ellipse(new RawVector2(x, y), radius, radius), _brushContainer[brush], stroke);
        ...
        /// <param name="brush">The brush.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void FillRectangle(float x, float y, float width, float height, int brush) => _device.FillRectangle(new RawRectangleF(x, y, x + width, y + height), _brushContainer[brush]);
        ...
        /// <param name="brush">The brush.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void FillCircle(float x, float y, int radius, int brush) => _device.FillEllipse(new Ellipse(new RawVector2(x, y), radius, radius), _brushContainer[brush]);
        ...
        {
            _device.DrawBitmap(bitmap, new RawRectangleF(x, y, x + bitmap.Size.Width, y + bitmap.Size.Height), opacity, interpolationMode);
        }

        public void FillEllipse(float x, float y, int radius, int brush) => _device.FillEllipse(new Ellipse(new RawVector2(x, y), radius, radius), _brushContainer[brush]);

        public void DrawText(string statusText, float v1, float textY, int textBrush, int v2)
        {
